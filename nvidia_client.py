...
async def chat(history: list[dict], model: str = CHAT_MODEL) -> AsyncGenerator[str, None]:
    ...
    system_prompt = (
        ...
        "4. **No other imports** or network/disk access is allowed. DO NOT import 'requests', 'urllib', 'http'. If asked for internet data or images, you MUST generate placeholder text or solid color images locally. DO NOT import 'Link' from reportlab.platypus and DO NOT import 'getNormalStyle' from reportlab.lib.styles.\n"
